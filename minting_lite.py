import sys, sqlite3, collections, argparse, csv
...
class Node:
    def __init__(self, node_id, period, verbose=False):
        ...
        # This is probably always the same as the "last_reported_at" value used in minting, but we track it separately here to avoid disturbing the code to make sure it's set before we need to use it
    ...
    def credit_uptime(self, uptime, timestamp, note="", post_period=False):
        ...
        # "Downtime" can be slightly negative sometimes and still be valid. We track this mostly as a sanity check, because it should always be equal to the period duration minus the uptime
...
if __name__ == "__main__":
    ...
    period = grid3.minting.Period(offset=grid3.minting.Period().offset - 1)
